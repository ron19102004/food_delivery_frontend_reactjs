    ...
    <div>
      ...
      >
        <div className="md:flex items-center md:space-x-2 font-font3">
          <div className="md:rounded-l-3xl basis-1/4 border h-10 inline-flex items-center justify-start md:justify-end px-2 w-full md:w-auto md:pr-2 bg-orange-600 text-white">
